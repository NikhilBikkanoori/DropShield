...
export default function StudentProfile() {
  ...
  const fetchLoggedInStudent = async () => {
    try {
      ...
      // Try to get data from localStorage first (for demo/direct login)
      ...
      // Fetch student data by ID if not in localStorage
    ...
    <div style={{ background: "#192047", minHeight: "100vh", margin: 0 }}>
      ...
      <div className="topbar">
        ...
        <button
          ...
          style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(162,244,249,0.15)', color: '#A2F4F9', border: '1px solid rgba(162,244,249,0.3)', padding: '8px 16px', margin: 0 }}
        >
          ← Back
        </button>
      </div>
