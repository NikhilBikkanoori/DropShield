    ...
    <div className="min-h-screen bg-gray-100">
      <nav className="bg-purple-700 text-white px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex gap-2 items-center">
          <button onClick={() => navigate('/')} className="bg-purple-600 hover:bg-purple-500 border border-purple-400 px-3 py-1 rounded text-sm font-semibold flex items-center gap-1 transition-colors">
            &larr; Back to Home
          </button>
            ...
            {[
              ...
              <li key={s}>
                <button
                  ...
                  className={`w-full text-left hover:bg-gray-700 p-2 rounded ${activeSection === s ? "bg-gray-700" : " "
                    }`}
                >
