...
const API_BASE = `${process.env.REACT_APP_API_BASE_URL || "https://dropshieldbe-a3fmaucneacte4av.southindia-01.azurewebsites.net"}/api/student-admin`;
...
export default function AdminStudents({
  ...
  const importData = async (e) => {
    ...
    try {
      const res = await fetch(`${process.env.REACT_APP_API_BASE_URL || "http://localhost:6000"}/api/student-admin/upload-students-csv`, {
        method: 'POST',
