...
const API_BASE = `${process.env.REACT_APP_API_BASE_URL || "https://dropshieldbe-a3fmaucneacte4av.southindia-01.azurewebsites.net"}/api/parent-admin`;
const STUDENT_API_BASE = `${process.env.REACT_APP_API_BASE_URL || "http://localhost:6000"}/api/student-admin`;
